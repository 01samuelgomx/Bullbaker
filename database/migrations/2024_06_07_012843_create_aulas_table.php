...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tblAulas', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('idCurso'); // Cria um campo BIGINT para relacionar com a tabela Cursos
            $table->foreign('idCurso')->references('idCurso')->on('tblCurso')->onDelete('cascade'); // Define a chave estrangeira
