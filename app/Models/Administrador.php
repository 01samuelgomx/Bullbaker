...
class Administrador extends Model
{
    ...
    {
        return [
            'nomeAdmin'                => 'unique:tbladministrador,nomeAdmin,'.$this->id.'|min:3',
            'emailAdmin'               => 'unique:tbladministrador,emailAdmin,'.$this->id.'|email',
            'telefoneAdmin'            => 'unique:tbladministrador,telefoneAdmin,'.$this->id.'|min:10',
            'dataCadAdmin'             => 'date',
            ...
            'statusAdmin'              => 'in:ativo,desativado',
            'fotoAdmin'                => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'tipoAdministrador'        => 'in:super,regular',
        ];
    }
