...
<head>
    <!-- Meta-Information -->
    <title>Editar Tabela notificação</title>
    <meta charset="utf-8">
...
<body class="expand-data panel-data">
    ...
    <div class="panel-content">
        <div class="widget pad50-65">
            ...
            <form action="{{ route('update.notificacao', $editNotificacao->idNotificacao) }}" method="POST"
                role="form text-left" enctype="multipart/form-data" class="contact-form">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="widget-title2">
                        <div class="pr-tp-inr">
                            <h4>Faça a Atualização das notificações</h4>
                    ...
                    <div class="file-input-container" style="margin-bottom:30px;">
                        <input type="file" id="file-input" accept="image/*" onchange="displayImage(event)"
                            name="fotoNotificacao">
                        <label for="file-input" class="file-label">
                            <img id="icon"
                                src="{{ isset($editNotificacao->fotoNotificacao) && $editNotificacao->fotoNotificacao ? asset('storage/img/notificacao/' . $editNotificacao->fotoNotificacao) : asset('public/img/camera.png') }}"
                ...
                <div class="row mrg20">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <input class="brd-rd5" type="text" placeholder="Titulo:" name="tituloNotificacao"
                            id="tituloNotificacao"
                            value="{{ old('tituloNotificacao', $editNotificacao->tituloNotificacao) }}" />
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <input class="brd-rd5" type="text" placeholder="Mensagem:" name="mensagemNotificacao"
                            id="mensagemNotificacao"
                            value="{{ old('mensagemNotificacao', $editNotificacao->mensagemNotificacao) }}" />
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <select class="brd-rd5" name="statusNotificacao" id="statusNotificacao" required>
                                    <option value="ativo" class="brd-rd5"
                                        {{ old('statusNotificacao', $editNotificacao->statusNotificacao) == 'ativo' ? 'selected' : '' }}>
                                        Ativo
                                    </option>
                                    <option value="desativo" class="brd-rd5"
                                        {{ old('statusNotificacao', $editNotificacao->statusNotificacao) == 'desativo' ? 'selected' : '' }}>
                                        Desativo</option>
                                </select>
