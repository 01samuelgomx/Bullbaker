                    ...
                    <div class="row mrg20">
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="date" placeholder="Nome:" name="dataDeNascimento"
                                id="dataDeNascimento"
                                value="{{ old('dataDeNascimento', $editAluno->dataDeNascimento) }}" required />
                    ...
                    <div class="row mrg20">
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="text" placeholder="Estado do Aluno:" name="estadoAluno"
                                id="estadoAluno" value="{{ old('estadoAluno', $editAluno->estadoAluno) }}"
                                required />
                            @error('estadoAluno')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row mrg20">
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="text" placeholder="Nome Curso:" name="nomeCurso"
                                id="nomeCurso" value="{{ old('nomeCurso', $editAluno->nomeCurso) }}" required />
                            @error('nomeCurso')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <select class="brd-rd5" name="nivelHabilidade" id="nivelHabilidade" required>
                                <option value="Iniciante"
                                    {{ old('nivelHabilidade', $editAluno->nivelHabilidade) == 'Iniciante' ? 'selected' : '' }}>
                                    Iniciante</option>
                                <option value="Intermediário"
                                    {{ old('nivelHabilidade', $editAluno->nivelHabilidade) == 'Intermediário' ? 'selected' : '' }}>
                                    Intermediário</option>
                                <option value="Avançado"
                                    {{ old('nivelHabilidade', $editAluno->nivelHabilidade) == 'Avançado' ? 'selected' : '' }}>
                                    Avançado</option>
                            </select>
