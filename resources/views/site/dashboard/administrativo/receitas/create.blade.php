...
<body class="expand-data panel-data">
    ...
    <div class="pg-tp">
        <i class="ion-cube"></i>
        <div class="pr-tp-inr">
            <h4>Bem - Vindo a Area das Receitas!
            </h4>
                    ...
                    <div class="row mrg20">
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="text" placeholder="Nome da Receita:" name="nomeReceita"
                                id="nomeReceita" value="{{ old('nomeReceita') }}" required />
                            @error('nomeReceita')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="text" placeholder="Ingredientes:"
                                ...
                                value="{{ old('ingredienteReceita') }}" required />
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <input class="brd-rd5" type="text" placeholder="Modo de preparo:"
                                ...
                                value="{{ old('modoPreparoReceita') }}" required />
