                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="file-input-container" style="margin-bottom:30px;">
                        ...
                        <label for="file-input" class="file-label">
                            <img id="icon"
                                src="{{ isset($editReceita->fotoReceita) && $editReceita->fotoReceita ? asset('storage/img/receitas/' . $editReceita->fotoReceita) : asset('public/img/camera.png') }}"
                ...
                <div class="column mrg20">
                    <div class="row mrg20">
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            <p>Nome da Receita</p>
                            <input class="brd-rd5" type="text" placeholder="Nome da Receita:" name="nomeReceita"
                                id="nomeReceita" value="{{ old('nomeReceita', $editReceita->nomeReceita) }}"
                                required />
                            @error('nomeReceita')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            <p>Ingredientes</p>
                            <input class="brd-rd5" type="text" placeholder="Ingredientes:"
                                name="ingredienteReceita" id="ingredienteReceita"
                                value="{{ old('ingredienteReceita', $editReceita->ingredienteReceita) }}" required />
                            @error('ingredienteReceita')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            <p>Modo de preparo</p>
                            <input class="brd-rd5" type="text" placeholder="Modo de preparo:"
                                name="modoPreparoReceita" id="modoPreparoReceita"
                                value="{{ old('modoPreparoReceita', $editReceita->modoPreparoReceita) }}" required />
                            @error('modoPreparoReceita')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="row mrg20">
                        <div class="col-md-6 col-sm-12 col-lg-6">
                            ...
                            <select class="brd-rd5" name="statusReceita" id="statusReceita" required>
                                <option value="ativo"
                                    {{ old('statusReceita', $editReceita->statusReceita) == 'ativo' ? 'selected' : '' }}>
                                    Ativo</option>
                                <option value="desativo"
                                    {{ old('statusReceita', $editReceita->statusReceita) == 'desativo' ? 'selected' : '' }}>
                                    Desativo</option>
                            </select>
                            @error('statusReceita')
                                <span class="text-danger">{{ $message }}</span>
