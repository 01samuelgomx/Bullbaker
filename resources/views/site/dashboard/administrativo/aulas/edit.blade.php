      ...
      <div class="widget pad50-65">
       ...
       <div class="row mrg20">
            ...
            <div class="col-md-6 col-sm-12 col-lg-6">
              <input class="brd-rd5" type="email" placeholder="idCursos:" name="idCursos" id="idCursos" value="{{ old('idCursos') }}" />
            </div>

            <div class="col-md-6 col-sm-12 col-lg-6">
              <input class="brd-rd5" type="text" placeholder="Nome:" name="nomeAula" id="nomeAula" value="{{old('nomeAula')}}"/>
            </div>
       ...
       <div class="row mrg20">
            ...
            <div class="col-md-6 col-sm-12 col-lg-6">
              <input class="brd-rd5" type="text" placeholder="Descrisção:" name="descriscaoAula" id="descriscaoAula" value="{{ old('descriscaoAula') }} "/>
            </div>

            <div class="col-md-6 col-sm-12 col-lg-6">
              <input class="brd-rd5" type="email" placeholder="Duração:" name="duracaoAula" id="duracaoAula" value="{{ old('duracaoAula') }}"/>
            </div>

            <div class="col-md-6 col-sm-12 col-lg-6">
              <input class="brd-rd5" type="email" placeholder="Video:" name="Video_aula" id="Video_aula" value="{{ old('Video_aula') }}"/>
            </div>
